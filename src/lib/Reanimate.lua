...
local PostSimEvent = PostSim:Connect(function()
	if Character:FindFirstChild("HumanoidRootPart") and Is_NetworkOwner(Character:FindFirstChild("HumanoidRootPart")) == true then
		Align(Character:FindFirstChild("HumanoidRootPart"), Character:FindFirstChild("UpperTorso") or Figure:FindFirstChild("HumanoidRootPart"))
	end
